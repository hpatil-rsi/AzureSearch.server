...
{
    public abstract class suitesWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static suitesWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(suitesWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<suitesDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<suitesDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<suitesDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<suitesDbContext, Task<T>> func)
        {
            T result;
